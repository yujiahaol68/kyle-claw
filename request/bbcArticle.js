...
exports.reqArticle = function (req, res, next) {
    request.get('http://www.bbc.com/future/data/v1/search/story-by-tag/' + tag[0] + '/britain?page='+ page + '&itemsPerPage=' + itemNumber)
